--DROP FUNCTION get_fighter_basics_regressor(text, refcursor);
CREATE OR REPLACE FUNCTION get_fighter_basics_regressor(fighter text, mycursor refcursor) RETURNS refcursor AS $$
